...
**Both themes are first-class.** The page follows `prefers-color-scheme`, and every brand asset has a dark variant swapped through `<picture>`. Check both before shipping a change.
